...
class BankMain extends React.Component {
    ...
    componentDidUpdate() {
        if(this.props.forms.length > 1) {
            this.refForm.style.filter = 'blur(3px)';
        } else {
        ...
        return (
            <div className='headBank'>
                <div className='accountInfo'>
                    <div className='accountIco'>
                        <svg xmlns="http://www.w3.org/2000/svg" width="56.195" height="56.194" viewBox="0 0 56.195 56.194">
                ...
                <div className='moneyPanelBank'>
                    <div className='fieldMoneyBank'>
                        <div className='moneyBank'>${bank.cash.toLocaleString('ru-RU')}</div>
                        <div className='icoPanelBank' style={{marginRight: '9px'}}>
                            Наличные
                            <svg xmlns="http://www.w3.org/2000/svg" width="22.014" height="16.658" viewBox="0 0 22.014 16.658" fill='white' style={{marginLeft: '10px'}}>
                    ...
                    <div className='fieldMoneyBank'>
                        <div className='moneyBank'>${bank.money.toLocaleString('ru-RU')}</div>
                        <div className='icoPanelBank'>
                            На счету
                            <svg xmlns="http://www.w3.org/2000/svg" width="25.524" height="17.016" viewBox="0 0 25.524 17.016" style={{marginLeft: '10px'}}>
                    ...
                    <div className='fieldMoneyBank'>
                        <div className='moneyBank'>{String('00000000' + bank.number).slice(-8)}</div>
                        <div className='icoPanelBank' style={{marginRight: '12px'}}>
                            Номер счета
                            <svg xmlns="http://www.w3.org/2000/svg" width="14.597" height="16.682" viewBox="0 0 14.597 16.682" fill='white' style={{marginLeft: '10px'}}>
                    ...
                    <div className='fieldMoneyBank'>
                        <div className='moneyBank'>Classic</div>
                        <div className='icoPanelBank'>
                            Статус счета
                            <svg xmlns="http://www.w3.org/2000/svg" width="26.289" height="17.689" viewBox="0 0 26.289 17.689" fill='white' style={{marginLeft: '10px'}}>
    ...
    getPages() {
        return (
            this.props.pages.map((page, index) => <div key={index}>{page}</div>)
        )
    }
    ...
    getForm() {
        ...
        return(
            <div className='formBank' ref={(form) => {this.refForm = form}}>
                {this.getHead()}

                <div className='logoBlockBank'><img className='logoBank' src={require('../../../source_icons/bank/logo.png')}></img></div>
                <div className='exitBank' name='exit' onClick={this.exit.bind(this)}></div>
