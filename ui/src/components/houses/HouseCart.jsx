...
class HouseCart extends React.Component {
    ...
    exit(event) {
        ...
        if(this.state.enterList) {
            ...
            mp.trigger('houseMenuClose.client');
            this.props.closeForm();
        }
    }
    ...
    getButton(name) {
        ...
        switch(name) {
            case 'buy':
                im = require(`../../../source_icons/houses/money_${this.state.colorMoney}.png`)
                return(
                    <button 
                        name='money'
                        id='buttonHouse' 
            ...
            case 'look':
                im = require(`../../../source_icons/houses/magnifier_${this.state.colorMag}.png`)
                return(
                    <button 
                        name='mag'
                        id='buttonHouse' 
            ...
            case 'actions':
                im = require(`../../../source_icons/houses/actions_${this.state.colorAct}.png`)
                return(
                    <button 
                        name='act'
                        id='buttonHouse' 
            ...
            case 'enterHouse':
                im = require(`../../../source_icons/houses/enterHouse_${this.state.colorEntH}.png`)
                return(
                    <button 
                        name='entH'
                        id='buttonHouse' 
            ...
            case 'enterGarage':
                im = require(`../../../source_icons/houses/enterGarage_${this.state.colorEntG}.png`)
                return(
                    <button 
                        name='entG'
                        id='buttonHouse' 
            ...
            case 'enter':
                im = require(`../../../source_icons/houses/enter_${this.state.colorEnt}.png`)
                return(
                    <button 
                        name='ent'
                        id='buttonHouse' 
